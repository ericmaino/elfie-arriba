import WorkItemDetails from "../parts.optional/WorkItemDetails/WorkItemDetails";
    ...
    listingDefaults: {
        ...
        "Activities": { columns: ["ID", "Work Item Type", "Title", "State", "Assigned To"], sortColumn: "ID", sortOrder: "desc" },
        "ResourceRequests": { columns: ["ID", "Work Item Type", "Title", "State", "Assigned To"], sortColumn: "ID", sortOrder: "desc" },
        "EngineeringFeedback": { columns: ["ID", "Work Item Type", "Title", "State", "Assigned To"], sortColumn: "ID", sortOrder: "desc" },
    },
    ...
    customDetailsProviders: {
        ...
        "Activities": WorkItemDetails,
        "ResourceRequests": WorkItemDetails,
        "EngineeringFeedback": WorkItemDetails,
    },
